...
public class Authentication {
    ...
    public static CloseableHttpClient createHttpClient() throws Exception {
        ...
        RequestConfig requestConfig = RequestConfig.custom()
            .setConnectTimeout(Timeout.ofMinutes(5)) // How long to wait to establish a connection
            .setResponseTimeout(Timeout.ofMinutes(5)) // How long to wait for a response
            .setConnectionRequestTimeout(Timeout.ofMinutes(5)) // How long to wait for a connection from the pool
            .build();
